    ...
    public class RestaurantDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>()
                ...
                .UsingEntity(j => j.ToTable("BookingTables")); // creates linking table
            ...
            modelBuilder.Entity<Booking>().HasData(
                ...
                // Erik: Cancelled (We test the status-enum here)
                ...
                // Stig: Large company (Testing several tables)
            ...
            // 4. Linking table (Many-to-many)
            // The name in quotes must match the name EF Core has given the table
